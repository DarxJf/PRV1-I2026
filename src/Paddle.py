...
class Paddle:
    def __init__(self, x: int, y: int) -> None:
        ...
        self.catch: bool = False
        self.cannon:bool = False
    ...
    def render(self, surface: pygame.Surface) -> None:
        ...
        if self.cannon:
            surface.blit(self.texture, (self.x, self.y), self.frames[self.skin][self.size])
            surface.blit(settings.TEXTURES["cannon"], (self.x, self.y - 2))
            surface.blit(settings.TEXTURES["cannon"], (self.x + self.width - 8, self.y - 2))
